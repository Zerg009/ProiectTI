        ...
        <div class="d-flex justify-content-center align-items-center">
            <div class="w-75">
                <div class="d-flex justify-content-center mb-3">
                    <asp:Label ID="lblPageHeader" runat="server" CssClass="h2 text-center" Text="Adăugare Angajat Nou"></asp:Label>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="filePhoto" class="form-label">Fotografie</label>
